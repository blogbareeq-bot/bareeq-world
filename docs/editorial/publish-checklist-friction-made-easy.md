...
قبل النشر يستبدل المعرّف المؤقت `bareeqworld-21` بمعرّف حساب شركاء أمازون السعودية الفعلي، وتُراجع صفحة سياسة التحرير لتعكس وجود الروابط التابعة بصورة صريحة (تم التحديث في هذه الحزمة).
