...
if (!readinessAfter.includes("if (pkg.version !== '4.21.0') failures.push(`Expected package version 4.21.0, got ${pkg.version}`);")
  ...
  && !readinessAfter.includes("if (!['4.21.1', '4.21.2', '4.21.3', '4.21.4'].includes(pkg.version)) failures.push(`Expected supported package version 4.21.1–4.21.4, got ${pkg.version}`);")) throw new Error('V4.21: launch-readiness version gate or patch successor is missing.');
