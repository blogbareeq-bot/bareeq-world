...
const readinessAfter = readinessBefore
  ...
  .replace(
    'Launch-readiness source audit passed: V4.21.3 package identity',
    'Launch-readiness source audit passed: V4.22.0 package identity',
  );
if (!readinessAfter.includes("['4.21.1', '4.21.2', '4.21.3', '4.21.4', '4.21.5', '4.21.6', '4.22.0'].includes(pkg.version)")) {
