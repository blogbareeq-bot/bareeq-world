...
if (!['4.21.2', '4.21.3', '4.21.4', '4.21.5', '4.21.6'].includes(pkg.version)) throw new Error(`Expected package 4.21.2 through 4.21.6 successor, got ${pkg.version}.`);
...
requireAll('HomeIntro.astro', intro, ['اقرأ عبر سطور، أو استمع إلى النص عبر صدى، أو افتح نافذة بصرية على الفكرة.']);
...
console.log(`V4.21.2 compatibility gate passed inside V4.21.6: ${published} articles, useful editorial refinements, locked design-one header, measurable mobile ticker motion, preserved tag redirect, corrected summaries, clean audio output, and paused article layers.`);
