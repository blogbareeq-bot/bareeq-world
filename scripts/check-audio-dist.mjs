...
if (!['4.20.0', '4.21.0', '4.21.1', '4.21.2', '4.21.3'].includes(pkg.version)) throw new Error(`Audio-dist audit expected package 4.20.0 baseline or supported 4.21.x successor, got ${pkg.version}.`);
const freeGeminiRollout = ['4.21.1', '4.21.2', '4.21.3'].includes(pkg.version) && process.env.BAREEQ_GEMINI_FREE_ROLLOUT !== '0';
