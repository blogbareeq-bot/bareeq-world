...
if (!['4.21.3', '4.21.4', '4.21.5', '4.21.6', '4.22.0'].includes(pkg.version)) throw new Error(`V4.21.3 preparation expected package 4.21.3 or a supported successor, got ${pkg.version}.`);
