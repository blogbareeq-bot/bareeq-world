...
if (!supportedPkg || (!lockMatches && !rcMetadataOnly)) {
  throw new Error('package.json/package-lock must identify V4.21.3–V4.21.6 with matching dependency lock metadata.');
}
...
console.log('V4.21.3 compatibility gate passed inside V4.21.6: approved first header, real mobile wave, separate category cards, moving ticker, preserved utilities, and seven viewport screenshots are locked.');
