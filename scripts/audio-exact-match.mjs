...
export function assertIndependentAsrModels(models, { allowed = ['gemini-3.5-flash-lite', 'gemini-3.5-transcribe', 'gemini-3.5-flash', 'gemini-3.6-flash'], forbidden = ['gemini-3.6-transcribe'] } = {}) {
