...
if (!['4.21.0', '4.21.1', '4.21.2', '4.21.3', '4.21.4'].includes(pkg.version)) throw new Error(`Expected package 4.21.0 baseline or supported 4.21.x successor, got ${pkg.version}`);
